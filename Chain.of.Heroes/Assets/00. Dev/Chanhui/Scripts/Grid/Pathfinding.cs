...
public class Pathfinding : MonoBehaviour
{
   ...
   private int width;
    ...
    public bool HasAtPath(GridPosition startGridPosition, GridPosition endGridPosition)
    {
        return AttackFindPath(startGridPosition, endGridPosition, out int pathLength) != null;
    }
